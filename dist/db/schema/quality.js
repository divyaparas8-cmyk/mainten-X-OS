...
exports.ccpChecks = (0, pg_core_1.pgTable)("ccp_checks", {
    ...
    batchId: (0, pg_core_1.uuid)("batch_id").references(() => production_js_1.batches.id, { onDelete: "cascade" }).notNull(),
    ...
    operatorId: (0, pg_core_1.uuid)("operator_id").references(() => users_js_1.users.id, { onDelete: "set null" }).notNull(),
    verifiedBy: (0, pg_core_1.uuid)("verified_by").references(() => users_js_1.users.id, { onDelete: "set null" }),
...
exports.qaReleases = (0, pg_core_1.pgTable)("qa_releases", {
    ...
    tenantId: (0, pg_core_1.uuid)("tenant_id").references(() => tenants_js_1.tenants.id, { onDelete: "cascade" }).notNull(),
    plantId: (0, pg_core_1.uuid)("plant_id").references(() => tenants_js_1.plants.id, { onDelete: "cascade" }).notNull(),
    batchId: (0, pg_core_1.uuid)("batch_id").references(() => production_js_1.batches.id, { onDelete: "cascade" }).notNull().unique(),
    disposition: (0, pg_core_1.varchar)("disposition", { length: 50 }).notNull(), // "RELEASED", "REJECTED", "REWORK", "QUARANTINED"
    dispositionBy: (0, pg_core_1.uuid)("disposition_by").references(() => users_js_1.users.id, { onDelete: "restrict" }).notNull(),
...
exports.qualityHolds = (0, pg_core_1.pgTable)("quality_holds", {
    ...
    holdBy: (0, pg_core_1.uuid)("hold_by").references(() => users_js_1.users.id, { onDelete: "set null" }).notNull(),
...
exports.deviations = (0, pg_core_1.pgTable)("deviations", {
    ...
    reportedBy: (0, pg_core_1.uuid)("reported_by").references(() => users_js_1.users.id, { onDelete: "set null" }).notNull(),
