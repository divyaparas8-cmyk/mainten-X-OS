...
async function planningRoutes(fastify) {
    ...
    fastify.put("/forecast/promotions/:id", { schema: { tags: ["Planning & Demand"], summary: "Update Commercial Promotion Status" } }, planning_controller_js_1.planningController.updatePromotion.bind(planning_controller_js_1.planningController));
    fastify.delete("/forecast/promotions/:id", { schema: { tags: ["Planning & Demand"], summary: "Delete Commercial Promotion" } }, planning_controller_js_1.planningController.deletePromotionCampaign.bind(planning_controller_js_1.planningController));
    // Shipments Outbound
    ...
    fastify.post("/mrp/net-requirements/generate", { schema: { tags: ["Planning & Demand"], summary: "Generate Fresh MRP Requirements from Demand & BOMs" } }, planning_controller_js_1.planningController.generateMrpRequirements.bind(planning_controller_js_1.planningController));
    fastify.get("/mrp/net-requirements/:id", { schema: { tags: ["Planning & Demand"], summary: "Get MRP Net Requirement By ID" } }, planning_controller_js_1.planningController.getMrpRequirementById.bind(planning_controller_js_1.planningController));
    fastify.patch("/mrp/net-requirements/:id", { schema: { tags: ["Planning & Demand"], summary: "Update MRP Net Requirement" } }, planning_controller_js_1.planningController.updateMrpRequirement.bind(planning_controller_js_1.planningController));
    fastify.put("/mrp/net-requirements/:id", { schema: { tags: ["Planning & Demand"], summary: "Update MRP Net Requirement" } }, planning_controller_js_1.planningController.updateMrpRequirement.bind(planning_controller_js_1.planningController));
    fastify.delete("/mrp/net-requirements/:id", { schema: { tags: ["Planning & Demand"], summary: "Delete MRP Net Requirement" } }, planning_controller_js_1.planningController.deleteMrpRequirement.bind(planning_controller_js_1.planningController));
    ...
    fastify.patch("/promotions/:id", { schema: { tags: ["Planning & Demand"], summary: "Update Promotion Campaign" } }, planning_controller_js_1.planningController.updatePromotionCampaign.bind(planning_controller_js_1.planningController));
