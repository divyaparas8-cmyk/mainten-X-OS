...
exports.createTransactionSchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(["RECEIPT", "TRANSFER", "RESERVATION", "ISSUE", "CONSUMPTION", "ADJUSTMENT", "SHIPMENT"]).optional(),
    transactionType: zod_1.z.enum(["RECEIPT", "TRANSFER", "RESERVATION", "ISSUE", "CONSUMPTION", "ADJUSTMENT", "SHIPMENT"]).optional(),
    quantity: zod_1.z.coerce.number().optional().default(1),
    uom: zod_1.z.string().optional().default("Units"),
    fromBinId: zod_1.z.string().optional(),
    toBinId: zod_1.z.string().optional(),
