...
export async function planningRoutes(fastify: FastifyInstance) {
  ...
  fastify.delete("/demand/orders/:id", { schema: { tags: ["Planning & Demand"], summary: "Cancel/Delete Customer Demand Order" } }, planningController.deleteCustomerOrder.bind(planningController));
