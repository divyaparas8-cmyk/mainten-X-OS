...
async function runDatabaseSeed() {
    ...
    try {
        ...
        // 1. Seed Tenant
        const [demoTenant] = await database_js_1.db
        ...
        // 3. Seed Users
        const [plantManager] = await database_js_1.db
            ...
            .returning();
        const [planner] = await database_js_1.db
            .insert(index_js_1.users)
            .values({
            tenantId: demoTenant.id,
            ...
            .returning();
        const [qaLead] = await database_js_1.db
            .insert(index_js_1.users)
            .values({
            tenantId: demoTenant.id,
            ...
            .returning();
        const [operator] = await database_js_1.db
            .insert(index_js_1.users)
            .values({
            tenantId: demoTenant.id,
