...
exports.lotGenealogies = (0, pg_core_1.pgTable)("lot_genealogies", {
    ...
    parentLotId: (0, pg_core_1.uuid)("parent_lot_id").references(() => warehouse_1.inventoryLots.id, { onDelete: "cascade" }).notNull(), // Raw Material or Sub-assembly Lot
    childLotId: (0, pg_core_1.uuid)("child_lot_id").references(() => warehouse_1.inventoryLots.id, { onDelete: "cascade" }).notNull(), // Finished Good Lot
...
exports.recallEvents = (0, pg_core_1.pgTable)("recall_events", {
    ...
    initiatedBy: (0, pg_core_1.uuid)("initiated_by").references(() => users_1.users.id, { onDelete: "set null" }).notNull(),
