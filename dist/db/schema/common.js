...
exports.notifications = (0, pg_core_1.pgTable)("notifications", {
    ...
    plantId: (0, pg_core_1.uuid)("plant_id").references(() => tenants_js_1.plants.id, { onDelete: "cascade" }),
    userId: (0, pg_core_1.uuid)("user_id").references(() => users_js_1.users.id, { onDelete: "cascade" }),
...
exports.documents = (0, pg_core_1.pgTable)("documents", {
    ...
    authorId: (0, pg_core_1.uuid)("author_id").references(() => users_js_1.users.id, { onDelete: "set null" }),
    approvedBy: (0, pg_core_1.uuid)("approved_by").references(() => users_js_1.users.id, { onDelete: "set null" }),
...
exports.ciIdeas = (0, pg_core_1.pgTable)("ci_ideas", {
    ...
    submittedBy: (0, pg_core_1.uuid)("submitted_by").references(() => users_js_1.users.id, { onDelete: "set null" }),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
