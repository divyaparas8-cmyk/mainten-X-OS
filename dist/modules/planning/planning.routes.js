...
async function planningRoutes(fastify) {
    ...
    fastify.post("/ai/chat", { schema: { tags: ["Planning & Demand"], summary: "AI Copilot Production Heuristic Chat" } }, planning_controller_js_1.planningController.handleAiChat.bind(planning_controller_js_1.planningController));
