...
async function main() {
    const res = await pool.query("SELECT id, action, entity_type, entity_id, user_id, ip_address, created_at, old_values, new_values FROM audit_logs WHERE entity_type = 'Plan' ORDER BY created_at DESC");
