...
exports.productionOrders = (0, pg_core_1.pgTable)("production_orders", {
    ...
    lineId: (0, pg_core_1.uuid)("line_id").references(() => masterData_js_1.productionLines.id, { onDelete: "restrict" }).notNull(),
...
exports.batchSteps = (0, pg_core_1.pgTable)("batch_steps", {
    ...
    operatorId: (0, pg_core_1.uuid)("operator_id").references(() => users_js_1.users.id, { onDelete: "set null" }),
...
exports.downtimeLogs = (0, pg_core_1.pgTable)("downtime_logs", {
    ...
    assetId: (0, pg_core_1.uuid)("asset_id").references(() => masterData_js_1.assets.id, { onDelete: "set null" }),
    ...
    loggedBy: (0, pg_core_1.uuid)("logged_by").references(() => users_js_1.users.id, { onDelete: "set null" }),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
